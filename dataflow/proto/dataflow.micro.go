...
type DataFlowService interface {
	...
	CancelJob(ctx context.Context, in *CancelJobRequest, opts ...client.CallOption) (*CancelJobResponse, error)
}
...
func (c *dataFlowService) CancelJob(ctx context.Context, in *CancelJobRequest, opts ...client.CallOption) (*CancelJobResponse, error) {
	req := c.c.NewRequest(c.name, "DataFlow.CancelJob", in)
...
func RegisterDataFlowHandler(s server.Server, hdlr DataFlowHandler, opts ...server.HandlerOption) error {
	type dataFlow interface {
		...
		CancelJob(ctx context.Context, in *CancelJobRequest, out *CancelJobResponse) error
	}
...
func (h *dataFlowHandler) CancelJob(ctx context.Context, in *CancelJobRequest, out *CancelJobResponse) error {
	return h.DataFlowHandler.CancelJob(ctx, in, out)
}
